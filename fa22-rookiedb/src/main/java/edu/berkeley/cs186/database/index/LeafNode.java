...
//        }else{
//            List<DataBox> new_keys;
//            List<RecordId> new_rids;
//            new_keys = this.keys.subList(metadata.getOrder(), this.keys.size());
//            new_rids = this.rids.subList(metadata.getOrder(), this.rids.size());
//            this.keys = this.keys.subList(0, metadata.getOrder());
//            this.rids = this.rids.subList(0, metadata.getOrder());
...
//        }
//        rightSibling = Optional.of(buff.getLong());
//        int numberOfPairs = buff.getInt();
